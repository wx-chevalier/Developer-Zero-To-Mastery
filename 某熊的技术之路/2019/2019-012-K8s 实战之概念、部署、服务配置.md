...
本文是对于 [Kubernetes 实战](https://wx-chevalier.github.io/DistributedSystem-Series/#/?q=Kubernetes)系列文章的提炼。
...
[Kubernetes 实战](https://wx-chevalier.github.io/DistributedSystem-Series/#/?q=Kubernetes)系列中我们介绍了 Docker 本地搭建，基于 Ubuntu 手动搭建集群以及基于 Rancher 快速搭建集群等方式。使用 Rancher 可以自动和可视化的完成 Kubernetes 集群的安装工作，省去的繁琐的人工安装过程，然您快速投入的业务开发中。
...
[Kubernetes 实战/典型应用](https://wx-chevalier.github.io/DistributedSystem-Series/#/?q=Kubernetes)一节中，我们介绍了许多常见的中间件的配置部署方式。这里以简单的 HTTP 服务器为例，介绍常见的服务配置流程。
